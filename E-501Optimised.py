...
data_s = {
    'N2': {'n':454337.67, 'Hf':0.0, 'MW':28.01}, #mol/hr
    'O2': {'n':139175.44, 'Hf':0.0, 'MW':32.00},
    'Ar': {'n':7753.64,'Hf':0.0, 'MW':39.95},
    'H2O': {'n':0.35,'Hf':-242, 'MW':18.00}
    }
...
U = 110# W/m2/C see graph from coulson, find uncertainty
A = -deltaH/60**2/(Tm*U)

L = 3.66 #standard 12ft
...
jh= 3.2e-3# using 25% baffle cut cos thats the optimum, see fig 12.29 Re = 18819
...
jf_t = 3.6e-3 #see fig 12.24, Re = 23767
...
jf_s = 3.0e-2 #see fig 12.30, baffle cut 25% Re = 18819
